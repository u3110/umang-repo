...
def ymain(loc):
	...
	def EncryptandSave(image,key):
		...
		#imshow(encryptedImage)
		imsave("/home/ubuntu/Desktop/major/static/ye.jpg",encryptedImage)
	...
	def DecryptandSave(image,key):
		...
		imsave("/home/ubuntu/Desktop/major/static/yd.jpg", DecryptedImage)
	...
	#path="/home/ubuntu/Desktop/test.jpg"
	path=loc
	image=imread(path)
	orignalimage=image
	...
	imsave("/home/ubuntu/Desktop/major/static/share-1.jpg",share_1)

	start_time = time.time()
	enc=EncryptandSave(image,share_1)
	
	yetime=time.time() - start_time

	start_time = time.time()
	DecryptandSave(enc,share_1)

	ydtime=time.time() - start_time

	image=imread('/home/ubuntu/Desktop/major/static/yd.jpg')
	ysnr = psnr(orignalimage,image)
	
	
	a = ['/static/'+inLoc, '/static/ye.jpg', '/static/yd.jpg',yetime,ydtime,ysnr]
	return a
